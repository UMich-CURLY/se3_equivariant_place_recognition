...
exp_args.add_argument('--experiment-id', type=str, default='oxford',
                      help='experiment id')
exp_args.add_argument('-d', '--dataset-path', type=str,
...
net_args.add_argument('--input-num', type=int, default=4096,
...
net_args.add_argument('--search-radius', type=float, default=0.35)
